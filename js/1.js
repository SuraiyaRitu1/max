            ...
            typeof (r = function e() {
                    ...
                    if (
                      ...
                      return (
                        ...
                        Array.isArray(e.data) &&
                          (e.fields ||
                            (e.fields = (e.meta && e.meta.fields) || f),
                          e.fields ||
                      ...
                      function t(t, i) {
                        ...
                        for (r = 0; r < t.length; r++) {
                          var s = r,
                            a = t[r];
                          e.header &&
                            (s = r >= _.length ? "__parsed_extra" : _[r]),
              ...
              function g(e) {
                ...
                (this.parse = function (a, l, c) {
                  ...
                  if (!a) return J();
                  if (e.header && !l) {
                    var C = a.split(r)[0].split(i),
                      S = [],
                      O = {},
                      x = !1;
                    for (var I in C) {
                      var A = C[I];
                      w(e.transformHeader) && (A = e.transformHeader(A, I));
                      var T = A,
                        D = O[A] || 0;
                      for (
                  ...
                  if (h || (!1 !== h && -1 === a.indexOf(t))) {
                    for (var F = a.split(r), j = 0; j < F.length; j++) {
                      if (((E = F[j]), (f += E.length), j !== F.length - 1))
                        f += r.length;
                      else if (c) return J();
                      if (!n || E.substring(0, y) !== n) {
                        if (v) {
                          if (((k = []), B(E.split(i)), Q(), d)) return J();
                        } else B(E.split(i));
                        if (o && o <= j) return (k = k.slice(0, o)), J(!0);
                      }
                    }
                    return J();
                  }
                  for (
                    ...
                    if (a[f] !== t)
                      if (n && 0 === E.length && a.substring(f, f + y) === n) {
                        ...
                        if (-1 === M) break;
                        if (
                          (E.push(a.substring(f, M)), H(M + m), v && (Q(), d))
                        )
                          return J();
                        if (o && k.length >= o) return J(!0);
                      }
                    else
                      for (P = f, f++; ; ) {
                        ...
                        if (P === g - 1)
                          return W(a.substring(f, P).replace(U, t));
                        if (t !== u || a[P + 1] !== u) {
                          if (t === u || 0 === P || a[P - 1] !== u) {
                            ...
                            var N = K(M);
                            if (a.substring(P + 1 + N, P + 1 + N + m) === r) {
                              if (
                                (E.push(a.substring(f, P).replace(U, t)),
                                H(P + 1 + N + m),
                                (z = a.indexOf(i, f)),
